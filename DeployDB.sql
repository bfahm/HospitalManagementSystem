...
CREATE TABLE Rel_Treats(
	DocId		INT	NOT NULL,
	Pid			INT	NOT NULL	PRIMARY KEY,								-- When a patient is being treated by one doctor,
	Treatment	VARCHAR(50),												-- it should not be reentered and paired with another doctor
...
INSERT INTO Hos_Room VALUES (1, NULL)										--A Null Room where unemployed Wardboys sit.
